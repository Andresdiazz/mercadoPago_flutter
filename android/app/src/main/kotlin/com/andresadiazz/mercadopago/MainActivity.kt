package com.andresadiazz.mercadopago
...
class MainActivity: FlutterActivity() {
    ...
    private fun initFlutterChannels() {
        val channelMercadoPago = MethodChannel(flutterView, "andresadiazz.com/mercadoPago")
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        val channelMercadoPagoRespuesta = MethodChannel(flutterView, "andresadiazz.com/mercadoPagoRespuesta")
